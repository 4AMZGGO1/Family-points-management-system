        ...
        <div class="container">
            ...
            <div class="row mb-4 justify-content-center">
                <div class="col-md-3 col-lg-2 mb-3">
                    <a href="apply.php" class="quick-action d-block">
                ...
                <div class="col-md-3 col-lg-2 mb-3">
                    <a href="shop.php" class="quick-action d-block">
                ...
                <div class="col-md-3 col-lg-2 mb-3">
                    <a href="history.php" class="quick-action d-block">
                            ...
                            <div class="row">
                                <?php foreach ($categories as $category): ?>
                                    <div class="col-md-3 col-sm-6 mb-3">
                                        <a href="apply.php?category=<?php echo urlencode($category); ?>" 
